...
<head>
  ...
  <script>
    ...
    function onLoadStaffInfo(){
      ...
      xhttp.open("POST", "<%=origPath%>/customer/get?userid=<%=userid%>&path=_admin-edit-customer.jsp", true);
      xhttp.send();
    }
  </script>
</head>
...
<div class="ui middle aligned center aligned grid" style="margin-top: 20px">
  <div class="fields">
    <div class="field">
      <form submit='<%=origPath%>/customer/get?userid=<%=userid%>&path=_admin-edit-customer.jsp' method="POST">
